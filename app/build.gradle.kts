...
registerDownloadTask(
    ...
    srcUrl = "https://github.com/boshijingang/KernelPatch/releases/download/$kernelPatchVersion/kpimg-android",
...
registerDownloadTask(
    ...
    srcUrl = "https://github.com/boshijingang/KernelPatch/releases/download/$kernelPatchVersion/kptools-android",
...
registerDownloadTask(
    ...
    srcUrl = "https://github.com/boshijingang/KernelPatch/releases/download/0.10.7/kpatch-android",
